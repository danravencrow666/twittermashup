...
MY_CONSUMER_KEY = environ.get('clwV0cugbsc8b2ZpzqPkFsIcy')#Your Twitter API Consumer Key set in Heroku config
MY_CONSUMER_SECRET = environ.get('uLpRJ3aOhjlSoLVVOinO5P1Isorn98GBMDq1PfjQIoZu6GhOMp')#Your Consumer Secret Key set in Heroku config
MY_ACCESS_TOKEN_KEY = environ.get('1185025214020751361-PYy12ZnRjbnbaZHqX5iqBP9KwI3O2v')#Your Twitter API Access Token Key set in Heroku config
MY_ACCESS_TOKEN_SECRET = environ.get('pdr1ovf1nzFV52ZINx4VkOQSw9gaYIJ6gJeKt8CDd80in')#Your Access Token Secret set in Heroku config
...
TWITTER_SOURCE_ACCOUNTS = ["soyelcrowese","soyelcrowese"]  # A list of comma-separated, quote-enclosed Twitter handles of account that you'll generate tweets based on. It should look like ["account1", "account2"]. If you want just one account, no comma needed.
...
TWEET_ACCOUNT = "ebook_crow"  # The name of the account you're tweeting to.
